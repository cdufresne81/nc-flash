...
class TestStateMachineTransitions:
    ...
    def test_invalid_transition_logged(self, caplog):
        """Invalid state transition logs an error but doesn't raise."""
        fm = FlashManager()
...
class TestFlashManagerGuards:
    ...
    def test_dynamic_flash_requires_secure_module(self):
